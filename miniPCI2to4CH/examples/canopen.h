...
#define CANOPEN_H
 ...
 #include <devctl.h>
 #include <stdint.h>
 /* QNX driver supports only little endian HW */
 #define HICO_LE
#else /* Linux */
 #define IOC_MAGIC 'E'//#ifndef CANOPEN_H
#define CANOPEN_H
...
/**************************************************************************/
#define IOC_SET_BTR	                       _IOW (IOC_MAGIC, 32, uint32_t)
/**************************************************************************/
/* Set a custom value to the bitrate configuration register
 *
 * NOTE: if you use this, IOC_GET_BITRATE call and /proc/hcanpci/\* entry
 * (Linux driver) will show an incorrect baudrate value. */
 ...
 * values */
/* HiCO.CAN-MiniPCI (2-channel) */
#define HW_HICOCAN_MPCI 0x10
/* HiCO.CAN-MiniPCI (4-channel) */
...
//        uint16_t dlc_co:4;
//        uint16_t rtr_co:1;
//        uint16_t fun_cod_co:4;
//        uint16_t id_co:7;
//        uint16_t reserved_co:6;
//    }PACKED;
//#endif
//    }PACKED;
